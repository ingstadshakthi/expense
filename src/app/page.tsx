...
export default async function Home() {
  ...
  return (
    <div className="fixed top-[53px] left-0 flex min-h-[calc(100vh-53px)] w-full flex-col items-center justify-center gap-6 bg-gradient-to-b from-white via-blue-100 to-white px-4 py-24 text-center transition-colors duration-300 sm:gap-10 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      {/* Top tagline */}
      ...
      <div className="flex max-w-2xl flex-col gap-3">
        ...
        <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          habits, and make informed financial decisions — all in a clean, intuitive dashboard
